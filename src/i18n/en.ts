...
export const en = {
  ...
  'upload.preview': 'Preview PDF',
  'upload.previewLabel': 'Preview the PDF of {file}',
  'upload.startOne': 'Upload file',
  'upload.startLabel': 'Upload file — {file}',
  'upload.startHint': 'Nothing leaves your computer until you press upload on its row.',
